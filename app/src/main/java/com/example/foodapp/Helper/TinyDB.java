...
public class TinyDB {
    ...
    public ArrayList<TrendingDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<TrendingDomain> playerList =  new ArrayList<TrendingDomain>();

        for(String jObjString : objStrings){
            TrendingDomain player  = gson.fromJson(jObjString, TrendingDomain.class);
    ...
    public void putListObject(String key, ArrayList<TrendingDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(TrendingDomain player: playerList){
